...
unlocked to sign the Orobit-Qt.app bundle.
...
allowing somebody to distribute a Orobit-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the orobit-qt.exe file inside the installer had not been tampered with.
